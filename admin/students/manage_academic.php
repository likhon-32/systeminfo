        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <select name="semester" id="semester" class="form-control form-control-sm  form-control-border rounded-0" required>
                    ...
                    <option <?= (isset($semester) && $semester == 'Third Semester') ? 'selected' : '' ?>>Fourth Semester</option>
                    <option <?= (isset($semester) && $semester == 'Third Semester') ? 'selected' : '' ?>>Fifth Semester</option>
                    <option <?= (isset($semester) && $semester == 'Third Semester') ? 'selected' : '' ?>>Sixth Semester</option>
                    <option <?= (isset($semester) && $semester == 'Third Semester') ? 'selected' : '' ?>>Seventh Semester</option>
                    <option <?= (isset($semester) && $semester == 'Third Semester') ? 'selected' : '' ?>>Eight Semester</option>
                    <option <?= (isset($semester) && $semester == 'Third Semester') ? 'selected' : '' ?>>Nine Semester</option>
                </select>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <select name="course_id" id="course_id" class="form-control form-control-sm form-control-border rounded-0 select2" required>
                    ...
                    <?php 
                        $courses = $conn->query("SELECT c.*, d.name as department FROM `course_list` c inner join `department_list` d on c.department_id = d.id where c.delete_flag = 0".(isset($course_id) ? " or c.id = '{$course_id}' " : "")." order by d.name asc, c.name asc ");
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="status" class="form-control form-control-sm form-control-border rounded-0" required>
                    <option value="1" <?= (isset($status) && $status == 1) ? 'selected' : '' ?>>Pass</option>
                    <option value="2" <?= (isset($status) && $status == 2) ? 'selected' : '' ?>>Fail</option>
                    <option value="2" <?= (isset($status) && $status == 2) ? 'selected' : '' ?>>Running</option>
                </select>
            </div>
        </div>
        </div>

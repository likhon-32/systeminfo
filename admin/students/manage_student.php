                ...
                <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
                    <fieldset class="border-bottom">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="reg_no" class="control-label">Registratioon number</label>
                                <input type="text" name="reg_no" id="reg_no" autofocus value="<?= isset($reg_no) ? $reg_no : "" ?>" class="form-control form-control-sm rounded-0" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4">

				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="text-center"><p class="m-0 truncate-1"><?php echo $row['name'] ?></p></td>
...
<script>
	$(document).ready(function(){
        ...
        $('.edit_data').click(function(){
			uni_modal("Update Department Details","departments/manage_department.php?id="+$(this).attr('data-id'))
		})
